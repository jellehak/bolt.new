...
export const ChatImpl = memo(({ initialMessages, storeMessageHistory }) => {
    useShortcuts();
    ...
    const sendMessage = async (_event, messageInput) => {
